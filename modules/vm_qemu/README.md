...
This repository contains Terraform module for provisioning virtual machines on Proxmox using Cloud-Init for configuration management. The modules provide reusable and configurable components that can be used to define and deploy virtual machines in a Proxmox environment.

Requires cloud-init enabled VM template to work.

Requires connection to Proxmox host to SCP the cloud-init file to the server.
